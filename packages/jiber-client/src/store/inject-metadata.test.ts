...
test('actions with existing metadata are not altered', () => {
  const action = { type: 'test', $doc: 'testRoom', $actionId: 5 }
  injectMetadata(store, action)
